...
public class MusicalInstrumentsCategoryImpl extends CategoryImpl {

    public MusicalInstrumentsCategoryImpl() {
        super(Category.MUSICAL_INSTRUMENTS);
    }

    @Override
    public void initIds() {
        idName = R.string.fruitCategory;
        idIcon = R.drawable.icon_category_musical_instruments;

...
public class AnimalHouseholdsCategoryImpl extends CategoryImpl {

    public AnimalHouseholdsCategoryImpl() {
        super(Category.ANIMAL_HOUSEHOLDS);
    }

    @Override
    public void initIds() {
        idName = R.string.fruitCategory;
        idIcon = R.drawable.icon_category_animal_households;

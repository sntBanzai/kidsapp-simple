package pl.wroc.waw.kidsapp_simple.testAnimation;
...
//
//                System.out.println("im bim bim bim bim bim");
//
//            }
//        });
        ...
        mRootView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ExpandButtonLayout target = (ExpandButtonLayout) findViewById(R.id.expandedButton);
                target.toggle();
                System.out.println("KLIK KLIK KLIK KLIK KLIK KLIK KLIKWWW");
            }
        });

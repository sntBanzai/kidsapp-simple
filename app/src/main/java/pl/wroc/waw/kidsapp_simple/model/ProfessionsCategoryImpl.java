...
public class ProfessionsCategoryImpl extends CategoryImpl {

    public ProfessionsCategoryImpl() {
        super(Category.PROFESSIONS);
    }

    @Override
    public void initIds() {
        idName = R.string.fruitCategory;
        idIcon = R.drawable.icon_category_professions;

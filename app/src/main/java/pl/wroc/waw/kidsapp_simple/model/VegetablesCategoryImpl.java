...
public class VegetablesCategoryImpl extends CategoryImpl {

    public VegetablesCategoryImpl() {
        super(Category.VEGETABLES);
    }

    @Override
    public void initIds() {
        idName = R.string.fruitCategory;
        idIcon = R.drawable.icon_category_vegetables;

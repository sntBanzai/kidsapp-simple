...
public class SeaAnimalsCategoryImpl extends CategoryImpl {

    public SeaAnimalsCategoryImpl() {
        super(Category.SEA_ANIMALS);
    }

    @Override
    public void initIds() {
        idName = R.string.fruitCategory;
        idIcon = R.drawable.icon_category_sea_animals;
